    ...
    .prompt([
      {
        ...
        choices: ["Return to bridge", `Update ${table}`, "Exit Reaver CMS"],
      },
    ])
    .then((menu) => {
      console.clear();
